...
IdentityClientId = "mixbrsorrisot"
IdentityClientSecret = "R6zCnAMB5jwj2bME"
IdentityUsername = "ulisses.magalhaes@sorrisodetoledo.com.br"
IdentityPassword = "Um2449@2025!"
GroupId = "$groupid$"
...
## Retrieving GroupID ##
GetGroupId = ApiUrl + "/api/organisationgroups"
print("Request: " + GetGroupId)
print("Authorization: " + BearerToken)
AssetsResponse = requests.get(GetGroupId, headers = {"accept":"application/json", "Authorization":BearerToken })
print(AssetsResponse.status_code, AssetsResponse.reason)
Group = json.loads(AssetsResponse.content)
GroupId = str(Group[0]["GroupId"])
print("GroupId: "+ GroupId)


## Acesso de Evento :: Get All Assets ##
